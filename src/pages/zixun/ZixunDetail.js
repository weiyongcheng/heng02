                ...
                <View style={{flex: 1, flexDirection: 'row'}}>
                    ...
                    <View style={{flex: 1, backgroundColor: '#4B31C2'}}>
                        <View style={{marginLeft: 13, marginTop: 8, marginBottom: 10}}>
                            <Text style={{fontSize: 8, color: '#dbdbdb'}} numberOfLines={1}>科技时代了飞机螺丝钉解放:</Text>
                            <Text style={{fontSize: 12, color: '#ffffff'}} numberOfLines={1}>科技时代了飞机螺科技时代了飞机螺丝钉解放科技时代了飞机螺丝钉解放丝钉解放</Text>
                        </View>
                    </View>
                </View>
